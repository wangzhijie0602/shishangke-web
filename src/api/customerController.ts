...
export async function customerAddressDefault(options?: { [key: string]: any }) {
  return request<API.ResultCustomerAddressVO>('/api/v1/customer/address/default', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function customerAddressDelete(
  ...
  return request<API.ResultString>(`/api/v1/customer/address/delete/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function customerAddressList(options?: { [key: string]: any }) {
  return request<API.ResultListCustomerAddressVO>('/api/v1/customer/address/list', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function customerAddressSetDefault(
  ...
  const { addressId: param0, ...queryParams } = params
  return request<API.ResultString>(`/api/v1/customer/address/set-default/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function customerUpdateAvatar(body: {}, options?: { [key: string]: any }) {
